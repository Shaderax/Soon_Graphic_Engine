...
namespace Soon
{
	...
	public:
		...
		VertexBufferRenderer CreateVertexBuffer(uint8_t *ptrData, uint32_t size, VmaAllocation& allocation);
		VertexBufferRenderer CreateStorageBuffer(void *ptrData, uint32_t size, VmaAllocation& allocation);
		...
		BufferRenderer	CreateUniformBuffers(size_t size, VmaAllocation& allocation);
		...
		IndiceBufferRenderer	CreateIndexBuffer(uint32_t *indexData, uint32_t size, VmaAllocation& allocation );
